...
class InvoiceToManufacturer(Database):
    ID_and_quantity_dictionary = {}   # Declaring variables and an empty dictionary.
    current_date = ''
    current_time = ''
    invoice_number_manufacturer = ''
    due_date = ''
    order_number_manufacturer = 4000
    number_of_bills_manufacturer = '001'
    name_of_manufacturer = ''
    address_of_manufacturer = ''
    phone_number_of_manufacturer = ''
    email_of_manufacturer = ''
    name_of_user = ''
    ...
    def set_name_of_manufacturer(self, name_of_manufacturer): # Defining setter and getter methods.
        self.name_of_manufacturer = name_of_manufacturer

    def get_name_of_manufacturer(self):
        return self.name_of_manufacturer
    ...
    def set_email_of_user(self, email_of_user):
        self.email_of_user = email_of_user

    def get_email_of_user(self):
        return self.email_of_user

    def set_address_of_manufacturer(self, address_of_manufacturer):
        self.address_of_manufacturer = address_of_manufacturer

    def get_address_of_manufacturer(self):
        return self.address_of_manufacturer

    def set_phone_number_of_manufacturer(self, phone_number_of_manufacturer):
        self.phone_number_of_manufacturer = phone_number_of_manufacturer

    def get_phone_number_of_manufacturer(self):
        return self.phone_number_of_manufacturer

    def set_email_of_manufacturer(self, email_of_manufacturer):
        self.email_of_manufacturer = email_of_manufacturer

    def get_email_of_manufacturer(self):
        return self.email_of_manufacturer
    ...
    def get_order_number_manufacturer(self):
        return self.order_number_manufacturer

    def get_number_of_bills_manufacturer(self):
        return self.number_of_bills_manufacturer

    def generate_amount_in_words(self, amount):
        dictionary_of_number_single_digit = {'1': 'one', '2': 'two', '3': 'three', '4': 'four', '5': 'five', '6': 'six',
                                             '7': 'seven', '8': 'eight', '9': 'nine'}
        dictionary_of_number_eleven_to_nineteen = {'11': 'eleven', '12': 'twelve', '13': 'thirteen', '14': 'fourteen',
                                                   '15': 'fifteen', '16': 'sixteen', '17': 'seventeen',
                                                   '18': 'eighteen', '19': 'nineteen'}
        dictionary_of_number_double_digits = {'10': 'ten', '20': 'twenty', '30': 'thirty', '40': 'forty', '50': 'fifty',
        ...
        def amount_in_words_for_three_digits(amount):
            ...
            if int(amount_array[1]) == 0 and int(amount_array[2]) == 0:
                ...
                amount_in_words_array.append(
                    ' ' + amount_in_word_for_two_digits(int(amount_array[1] + amount_array[2])))
                amount_in_words = ''.join(amount_in_words_array)
        ...
        def amount_in_words_for_four_digits(amount):
            ...
            if int(amount_array[1]) == 0 and int(amount_array[2]) == 0 and int(amount_array[3]) == 0:
                ...
                amount_in_words_array.append(
                    ' ' + amount_in_words_for_three_digits(int(amount_array[1] + amount_array[2] + amount_array[3])))
                amount_in_words = ''.join(amount_in_words_array)
            elif int(amount_array[2]) != 0:
                amount_in_words_array.append(
                    ' ' + amount_in_word_for_two_digits(int(amount_array[2] + amount_array[3])))
                amount_in_words = ''.join(amount_in_words_array)
        ...
        def amount_in_words_for_five_digits(amount):
            ...
            amount_in_words_array.append(
                amount_in_word_for_two_digits(int(amount_array[0] + amount_array[1])) + ' thousand')

            if int(amount_array[2]) == 0 and int(amount_array[3]) == 0 and int(amount_array[4]) == 0:
                amount_in_words = ''.join(amount_in_words_array)
            elif int(amount_array[2]) != 0:
                amount_in_words_array.append(
                    ' ' + amount_in_words_for_three_digits(int(amount_array[2] + amount_array[3] + amount_array[4])))
                amount_in_words = ''.join(amount_in_words_array)
            elif int(amount_array[3]) != 0:
                amount_in_words_array.append(
                    ' ' + amount_in_word_for_two_digits(int(amount_array[3] + amount_array[4])))
                amount_in_words = ''.join(amount_in_words_array)
        ...
        def amount_in_words_for_six_digits(amount):
            ...
            amount_in_words_array.append(amount_in_words_for_three_digits(
                int(amount_array[0] + amount_array[1] + amount_array[2])) + ' thousand')
            amount_in_words = ''.join(amount_in_words_array)

            if int(amount_array[3]) != 0:
                amount_in_words_array.append(
                    ' ' + amount_in_words_for_three_digits(int(amount_array[3] + amount_array[4] + amount_array[5])))
                amount_in_words = ''.join(amount_in_words_array)
            elif int(amount_array[4]) != 0:
                amount_in_words_array.append(
                    ' ' + amount_in_word_for_two_digits(int(amount_array[4] + amount_array[5])))
                amount_in_words = ''.join(amount_in_words_array)
        ...
        def amount_in_words_for_seven_digits(amount):
            ...
            if int(amount_array[1]) == 0 and int(amount_array[2]) == 0 and int(amount_array[3]) == 0 and int(
                    amount_array[4]) == 0 and int(amount_array[5]) == 0 and int(amount_array[6]) == 0:
                amount_in_words = ''.join(amount_in_words_array)
            elif int(amount_array[1]) != 0:
                amount_in_words_array.append(' ' + amount_in_words_for_six_digits(int(
                    amount_array[1] + amount_array[2] + amount_array[3] + amount_array[4] + amount_array[5] +
                    amount_array[6])))
                amount_in_words = ''.join(amount_in_words_array)
            elif int(amount_array[2]) != 0:
                amount_in_words_array.append(' ' + amount_in_words_for_five_digits(
                    int(amount_array[2] + amount_array[3] + amount_array[4] + amount_array[5] + amount_array[6])))
                amount_in_words = ''.join(amount_in_words_array)
            elif int(amount_array[3]) != 0:
                amount_in_words_array.append(' ' + amount_in_words_for_four_digits(
                    int(amount_array[3] + amount_array[4] + amount_array[5] + amount_array[6])))
                amount_in_words = ''.join(amount_in_words_array)
            elif int(amount_array[4]) != 0:
                amount_in_words_array.append(
                    ' ' + amount_in_words_for_three_digits(int(amount_array[4] + amount_array[5] + amount_array[6])))
                amount_in_words = ''.join(amount_in_words_array)
            elif int(amount_array[5]) != 0:
                amount_in_words_array.append(
                    ' ' + amount_in_word_for_two_digits(int(amount_array[5] + amount_array[6])))
                amount_in_words = ''.join(amount_in_words_array)
        ...
        def amount_in_words_for_eight_digits(amount):
            ...
            amount_in_words_array.append(
                amount_in_word_for_two_digits(int(amount_array[0] + amount_array[1])) + ' million')

            if int(amount_array[2]) == 0 and int(amount_array[3]) == 0 and int(amount_array[4]) == 0 and int(
                    amount_array[5]) == 0 and int(amount_array[6]) == 0 and int(amount_array[7]) == 0:
                amount_in_words = ''.join(amount_in_words_array)
            elif int(amount_array[2]) != 0:
                amount_in_words_array.append(' ' + amount_in_words_for_six_digits(int(
                    amount_array[2] + amount_array[3] + amount_array[4] + amount_array[5] + amount_array[6] +
                    amount_array[7])))
                amount_in_words = ''.join(amount_in_words_array)
            elif int(amount_array[3]) != 0:
                amount_in_words_array.append(' ' + amount_in_words_for_five_digits(
                    int(amount_array[3] + amount_array[4] + amount_array[5] + amount_array[6] + amount_array[7])))
                amount_in_words = ''.join(amount_in_words_array)
            elif int(amount_array[4]) != 0:
                amount_in_words_array.append(' ' + amount_in_words_for_four_digits(
                    int(amount_array[4] + amount_array[5] + amount_array[6] + amount_array[7])))
                amount_in_words = ''.join(amount_in_words_array)
            elif int(amount_array[5]) != 0:
                amount_in_words_array.append(
                    ' ' + amount_in_words_for_three_digits(int(amount_array[5] + amount_array[6] + amount_array[7])))
                amount_in_words = ''.join(amount_in_words_array)
            elif int(amount_array[6]) != 0:
                amount_in_words_array.append(
                    ' ' + amount_in_word_for_two_digits(int(amount_array[6] + amount_array[7])))
                amount_in_words = ''.join(amount_in_words_array)
        ...
        def amount_in_words_for_nine_digits(amount):
            ...
            amount_in_words_array.append(
                amount_in_words_for_three_digits(int(amount_array[0] + amount_array[1] + amount_array[2])) + ' million')

            if int(amount_array[3]) == 0 and int(amount_array[4]) == 0 and int(amount_array[5]) == 0 and int(
                    amount_array[6]) == 0 and int(amount_array[7]) == 0 and int(amount_array[8]) == 0:
                amount_in_words = ''.join(amount_in_words_array)
            elif int(amount_array[3]) != 0:
                amount_in_words_array.append(' ' + amount_in_words_for_six_digits(int(
                    amount_array[3] + amount_array[4] + amount_array[5] + amount_array[6] + amount_array[7] +
                    amount_array[8])))
                amount_in_words = ''.join(amount_in_words_array)
            elif int(amount_array[4]) != 0:
                amount_in_words_array.append(' ' + amount_in_words_for_five_digits(
                    int(amount_array[4] + amount_array[5] + amount_array[6] + amount_array[7] + amount_array[8])))
                amount_in_words = ''.join(amount_in_words_array)
            elif int(amount_array[5]) != 0:
                amount_in_words_array.append(' ' + amount_in_words_for_four_digits(
                    int(amount_array[5] + amount_array[6] + amount_array[7] + amount_array[8])))
                amount_in_words = ''.join(amount_in_words_array)
            elif int(amount_array[6]) != 0:
                amount_in_words_array.append(
                    ' ' + amount_in_words_for_three_digits(int(amount_array[6] + amount_array[7] + amount_array[8])))
                amount_in_words = ''.join(amount_in_words_array)
            elif int(amount_array[7]) != 0:
                amount_in_words_array.append(
                    ' ' + amount_in_word_for_two_digits(int(amount_array[7] + amount_array[8])))
                amount_in_words = ''.join(amount_in_words_array)
    ...
    def set_invoice_number_manufacturer(self):
        now = datetime.now()
        current_date = str(now).split()[0]
        current_date = current_date.split('-')
        current_date = ''.join(current_date)
        self.invoice_number_manufacturer = str(self.get_order_number_manufacturer()) + '-' + current_date + '-' + self.get_number_of_bills_manufacturer()

    def get_invoice_number_manufacturer(self):
        return self.invoice_number_manufacturer

    def set_number_of_bills_manufacturer(self):
        if int(self.get_number_of_bills_manufacturer()) < 9:
            self.number_of_bills_manufacturer = '00' + str(int(self.number_of_bills_manufacturer) + 1)
        elif int(self.get_number_of_bills_manufacturer()) >= 9 and int(self.get_number_of_bills_manufacturer()) < 99:
            self.number_of_bills_manufacturer = '0' + str(int(self.number_of_bills_manufacturer) + 1)
        else:
            self.number_of_bills_manufacturer = str(int(self.number_of_bills_manufacturer) + 1)

    def generate_invoice_manufacturer(self):

        empty_space_name_of_manufacturer = ''
        for i in range(95 - len(self.get_name_of_manufacturer())):
            empty_space_name_of_manufacturer += ' '

        empty_space_phone_number_of_manufacturer = ''
        for i in range(63 - len(self.get_phone_number_of_manufacturer())):
            empty_space_phone_number_of_manufacturer += ' '

        empty_space_address_of_manufacturer = ''
        for i in range(63 - len(self.get_address_of_manufacturer())):
            empty_space_address_of_manufacturer += ' '

        empty_space_email_of_manufacturer = ''
        for i in range(63 - len(self.get_email_of_manufacturer())):
            empty_space_email_of_manufacturer += ' '
        ...
        empty_space_email_of_user = ''
        for i in range(50 - len(self.get_email_of_user())):
            empty_space_email_of_user += ' '

        self.set_current_date()
        self.set_current_time()
        self.set_invoice_number_manufacturer()
        self.set_due_date()
        ...
        empty_space_invoice_number_manufacturer = ''
        for i in range(19 - len(self.get_invoice_number_manufacturer())):
            empty_space_invoice_number_manufacturer += ' '
        ...
        empty_space_order_number_manufacturer = ''
        for i in range(19 - len(str(self.get_order_number_manufacturer()))):
            empty_space_order_number_manufacturer += ' '
        ...
        first_array = ["\n", "\n", "\n", "\n",
                       ...
                       '                 |                                                                                                         |\n',
                       '                 |                                                                                                         |\n',
                      f"                 | {self.get_name_of_manufacturer()}{empty_space_name_of_manufacturer} Invoice |\n",
                       '                 |                                                                                                         |\n',
                       '                 |                                                                                                         |\n',
                       '                 +---------------------------------------------------------------------------------------------------------+\n',
                       '                 |                                                                                                         |\n',
                      f'                 | {self.get_address_of_manufacturer()}{empty_space_address_of_manufacturer} Date              | {self.get_current_date()}{empty_space_current_date} |\n',
                      f'                 | {self.get_email_of_manufacturer()}{empty_space_email_of_manufacturer} Time of purchase  | {self.get_current_time()}{empty_space_current_time} |\n',
                      f'                 | {self.get_phone_number_of_manufacturer()}{empty_space_phone_number_of_manufacturer} Your order number | {str(self.get_order_number_manufacturer())}{empty_space_order_number_manufacturer} |\n',
                      f'                 |                                                                 Invoice number    | {self.get_invoice_number_manufacturer()}{empty_space_invoice_number_manufacturer} |\n',
                      f'                 |                                                                 Due Date          | {self.get_due_date()}{empty_space_due_date} |\n',
                       ...
                       '                 +----------------------------------------------------+----------------------------------------------------+\n',
                       '                 |                                                    |                                                    |\n',
                      f"                 |  Nirajan's Electronics                             |                                                    |\n",
                      f'                 |  Bhatbhateni, Kathmandu                            |                                                    |\n',
                      f'                 |  np01cp4a220232@gmail.com                          |                                                    |\n',
                      f'                 |  98XXXXXXXX                                        |                                                    |\n',
                       '                 |                                                    |                                                    |\n',
                       '                 |                                                    |                                                    |\n',
                       '                 +----------------------------------------------------+----------------------------------------------------+\n',
        ...
        VAT_amount = 0.13 * float(subtotal)
        ...
        VAT_amount = "$" + "{0:.2f}".format(VAT_amount)
        subtotal = "$" + subtotal
        ...
        empty_space_VAT_amount = ''
        for i in range(14 - len(VAT_amount)):
            empty_space_VAT_amount += ' '
        ...
        third_array = [
            f'                 |                                                                            | Subtotal   | {subtotal}{empty_space_subtotal}|\n',
            '                 |                                                                            +------------+---------------+\n',
            f'                 |                                                                            | 13% VAT    | {VAT_amount}{empty_space_VAT_amount}|\n',
            '                 |                                                                            +------------+---------------+\n',
        ...
        empty_space_name_of_manufacturer = ''
        for i in range(50 - len(self.get_name_of_manufacturer())):
            empty_space_name_of_manufacturer += ' '

        empty_space_address_of_manufacturer = ''
        for i in range(50 - len(self.get_address_of_manufacturer())):
            empty_space_address_of_manufacturer += ' '

        empty_space_email_of_manufacturer = ''
        for i in range(50 - len(self.get_email_of_manufacturer())):
            empty_space_email_of_manufacturer += ' '
        ...
        fifth_array = [
            ...
            '                 +----------------------------------------------------+----------------------------------------------------+\n',
            '                 |                                                    |                                                    |\n',
           f"                 | {self.get_name_of_manufacturer()}{empty_space_name_of_manufacturer} |                                                    |\n",
           f'                 | {self.get_address_of_manufacturer()}{empty_space_address_of_manufacturer} |                                                    |\n',
           f'                 | {self.get_email_of_manufacturer()}{empty_space_email_of_manufacturer} |                                                    |\n',
            '                 |                                                    |                                                    |\n',
            '                 +----------------------------------------------------+----------------------------------------------------+\n',
            '                 |                                                                                                         |\n',
            '                 |                                                                                                         |\n',
        ...
        self.order_number_manufacturer += 1
        self.set_number_of_bills_manufacturer()
